...
function Aside() {
    ...
    return (
        <div>
            ...
            <div className={style.interactiveAside}>
                <span onClick={() => setOpenAside(true)} className="material-symbols-outlined">arrow_menu_open</span>
                {openASide && <ResponsiveAside setOpenAside={setOpenAside}/>}
            </div>
        </div>
    )
}
